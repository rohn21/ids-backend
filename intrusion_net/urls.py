...
from .views import URLInspectionViewSet, FileScanViewSet, InspectionChartsView, URLScanViewSet, CombinedInspectionChartView

router = DefaultRouter()
router.register(r'url-scan', URLInspectionViewSet, basename='url-inspect')
router.register(r'file-scan', FileScanViewSet, basename='file_scan')
...
urlpatterns = [
    ...
    path('inspection-charts/', InspectionChartsView.as_view(), name='inspection_charts'),
        path('chart/combined/', CombinedInspectionChartView.as_view(), name='chart-combined'),
